...
const config = {
  ...
  owner: {
    name: " 𝙷𝚊𝚗𝚣𝙿𝚒𝚠 𝙾𝚏𝚏𝚒𝚌𝚒𝚊𝚕", // Nama owner
    number: ["6285191782145"], // Format: 628xxx (tanpa + atau 0)
  },

  session: {
    pairingNumber: "6285762838242", // Nomor WA yang akan di-pair
  ...
  bot: {
    ...
    developer: "𝙷𝚊𝚗𝚣𝙿𝚒𝚠 𝙰𝚕𝚠𝚊𝚢𝚜 𝙼𝚒𝚕𝚒𝚔 𝙽𝚊𝚝𝚣𝚣♡", // Nama developer
  },
  ...
  donasi: {
    payment: [
      { name: "Dana", number: "085191782145", holder: "Na***" },
      { name: "GoPay", number: "082269817663", holder: "Han*P**" },
      { name: "OVO", number: "Not Found", holder: "Tidak Tersedia" },
    ],
    links: [
      { name: "Saweria", url: "saweria.co/hanzpiww" },
      { name: "Trakteer", url: "trakteer.id/hanzpiww" },
    ],
    benefits: [
