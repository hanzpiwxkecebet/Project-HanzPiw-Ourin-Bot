...
function getContextInfo(
  ...
  const saluranId = botConfig.saluran?.id || "120363418643907268@newsletter";
  const saluranName =
...
async function handler(m, { sock, config: botConfig, db, uptime }) {
  ...
  const saluranLink =
    ...
    "https://whatsapp.com/channel/0029VbAbAnH6hENiZ1MA6z3O";
  const {
    sorted: menuSorted,
    totalCmds,
    commandsByCategory,
...
Kamu bisa pakai aku buat cari info, ambil data, atau bantu hal-hal sederhana langsung lewat WhatsApp — praktis tanpa ribet.\n\n`;
      ...
      case 6:
        ...
        const saluranIdV6 =
          botConfig.saluran?.id || "120363418643907268@newsletter";
        const saluranNameV6 =
          botConfig.saluran?.name || botConfig.bot?.name || "Ourin-AI";
        const saluranLinkV6 =
          botConfig.saluran?.link ||
